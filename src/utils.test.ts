...
describe('normalize()', () => {
  ...
  it('normalizes complex rotations', () => {
    expect(normalize(`R2w`)).toBe('Rw2');
    expect(normalize(`R2'w`)).toBe('Rw2');
    expect(normalize(`Rw2'`)).toBe('Rw2');
    expect(normalize(`Rw'2`)).toBe('Rw2');
    expect(normalize(`R'w`)).toBe(`Rw'`);

    expect(normalize(`U2w`)).toBe('Uw2');
    expect(normalize(`U2'w`)).toBe('Uw2');
    expect(normalize(`Uw2'`)).toBe('Uw2');
    expect(normalize(`Uw'2`)).toBe('Uw2');
    expect(normalize(`U'w`)).toBe(`Uw'`);
